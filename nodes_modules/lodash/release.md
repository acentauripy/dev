...
npm run doc
npm i
git clone --depth=10 --branch=master git@github.com:lodash-archive/lodash-cli.git ./nodes_modules/lodash-cli
mkdir -p ./nodes_modules/lodash-cli/nodes_modules/lodash; cd $_; cp ../../../../lodash.js ./lodash.js; cp ../../../../package.json ./package.json
cd ../../; npm i --production; cd ../../
node ./nodes_modules/lodash-cli/bin/lodash core exports=node -o ./npm-package/core.js
node ./nodes_modules/lodash-cli/bin/lodash modularize exports=node -o ./npm-package
