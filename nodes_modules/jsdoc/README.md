...
JSDoc globally or in your project's `nodes_modules` folder.
...
`./nodes_modules/.bin`. To generate documentation for the file
`yourJavaScriptFile.js`:

    ./nodes_modules/.bin/jsdoc yourJavaScriptFile.js
