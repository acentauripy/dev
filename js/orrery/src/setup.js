...
import { OrbitControls } from "../../../nodes_modules/three/examples/jsm/controls/OrbitControls.js";
import { RenderPass } from "../../../nodes_modules/three/examples/jsm/postprocessing/RenderPass.js";
import { UnrealBloomPass } from "../../../nodes_modules/three/examples/jsm/postprocessing/UnrealBloomPass.js";
import { EffectComposer } from "../../../nodes_modules/three/examples/jsm/postprocessing/EffectComposer.js";
import { ShaderPass } from "../../../nodes_modules/three/examples/jsm/postprocessing/ShaderPass.js";
...
export const selectedPathMat = new THREE.LineBasicMaterial({ color: 0xffff66, linewidth: 1.5, transparent:true, opacity: 0.7 });
...
export let pathMaterials = [
    new THREE.LineBasicMaterial({ color: 0x999999, linewidth: 1, transparent:true, opacity: 0.5 }),
    new THREE.LineBasicMaterial({ color: 0x999999, linewidth: 1, transparent:true, opacity: 0.35 }),
    new THREE.LineBasicMaterial({ color: 0x999999, linewidth: 1, transparent:true, opacity: 0.3 }),
    new THREE.LineBasicMaterial({ color: 0x999999, linewidth: 1, transparent:true, opacity: 0.25 }),
    new THREE.LineBasicMaterial({ color: 0x999999, linewidth: 1, transparent:true, opacity: 0.2 })
];
